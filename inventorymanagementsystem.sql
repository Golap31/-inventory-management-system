...
--
-- Host: localhost
-- Generation Time: May 05, 2025 at 02:00 AM
-- Server version: 10.4.28-MariaDB
-- PHP Version: 8.2.4
...
CREATE TABLE `PURCHASE` (
  ...
  `ProductPurchased` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `PURCHASE` (`Purchase_ID`, `TotalAmount`, `PaidAmount`, `DueAmount`, `ProductPurchased`) VALUES
('1', 1.00, 1.00, 1.00, '1'),
('2', 2.00, 2.00, 2.00, '2');
